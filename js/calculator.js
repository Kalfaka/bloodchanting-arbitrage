 ...
 * Uses trillions (T) for large values, intelligently handles decimal places
...
export function formatMillions(millionsValue) {
  ...
  // For millions, intelligently handle decimals
  // If value is >= 100M, don't show decimals
  if (millionsValue >= 100) {
    return Math.floor(millionsValue) + 'M';
  }
